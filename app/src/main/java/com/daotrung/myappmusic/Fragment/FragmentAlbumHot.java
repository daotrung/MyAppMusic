...
import com.daotrung.myappmusic.Activity.DSAllAlbumActivity;
import com.daotrung.myappmusic.Adapter.AlbumAdapter;
...
public class FragmentAlbumHot extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        txtXemThemAlbum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), DSAllAlbumActivity.class);
    ...
    private void getData() {
        ...
        Call<List<Album>> callBack = dataService.getCategoryAlbum();
